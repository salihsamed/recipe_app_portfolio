...
const CreateRecipes = () => {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await axios.post("https://recipeapi-x7x0.onrender.com/recipes", recipe, {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <form
        className="flex flex-col w-[25%] max-sm:w-[90%]"
        onSubmit={onSubmit}
      >
        ...
        <button
          ...
          className="border mt-2 bg-gray-50"
          type="button"
        >
          Add Ingredient
        </button>
        ...
        <input
          ...
          required
        />
        <label htmlFor="cookingTime" className="font-semibold">
        ...
        <input
          ...
          onChange={handleChange}
        />
        <label htmlFor="preaparationTime" className="font-semibold">
        ...
        <button
          type="submit"
          className="bg-rose-400 border text-white py-1 rounded-lg mt-2 hover:bg-rose-500"
        >
          Submit
        </button>
      </form>
