...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between bg-rose-500 text-white h-[5vh] max-sm:h-[7vh] items-center px-2 relative'>
        ...
        <div className={`flex sm:gap-5 max-sm:flex-col max-sm:absolute max-sm:bg-rose-500 top-[5vh] max-sm:transition-all  max-sm:z-40 max-sm:h-auto max-sm:rounded-bl-xl max-sm:gap-3 max-sm:pr-3 max-sm:py-5 max-sm:pl-10 max-sm:w-auto ${menuVisibility?"right-0":"-right-[100%]"}`}>
